...
?>
  <article id="post-<?php the_ID(); ?>" <?php post_class('entry'); ?> aria-labelledby="section-heading-<?php the_ID(); ?>" role="article">
    ...
    <div id="client" class="content__wrapper">
      <div class="heading__bg heading__bg-clients">
        <h1 class="entry__title uppercase avenir-bold">
          <?php echo $force_home_header_client ?>
        </h1>
      </div>
      <h2 class="entry__title-sub uppercase avenir-demi-italic">
    ...
    <div class="divider avenir-bold">
      <a href="<?php echo $force_home_client_app_link; ?>" class="bg__green">
        <?php echo $froce_home_client_breaker_text; ?>
      </a>
    </div>
    
    <div id="intern" class="content__wrapper">
      <div class="heading__bg heading__bg-main">
        <h1 class="entry__title uppercase avenir-bold">
          <?php echo $force_home_header_intern ?>
        </h1>
      </div>
      <h2 class="entry__title-sub uppercase avenir-demi-italic">
    ...
    <div class="divider avenir-bold">
      <a href="<?php echo $force_home_intern_app_link; ?>" class="bg__yellow">
